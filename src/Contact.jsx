        ...
        <div
          ...
          <div
            ...
            <div
              ...
              <div
                ...
                <div>
                  <div style={{ fontFamily: "'Cinzel',serif", fontWeight: 700, fontSize: "14px", color: "#080808" }}>
                    RAO Cattle Farm
                  </div>
                  <div
                    style={{
              ...
              {GOOGLE_MAPS_API_KEY !== "YOUR_GOOGLE_MAPS_API_KEY" ? (
                ...
                <div
                  ...
                  <div style={{ fontFamily: "'Cinzel',serif", fontSize: "18px", color: t.goldB, textAlign: "center" }}>
                    Live Map Here
                  </div>
                  <div
                    style={{
                    ...
                    <br />
                    <br />
                    <strong style={{ color: t.text }}>Steps:</strong>
                    <br />
          ...
          <div
            ...
            <p
              ...
              Interested in our cattle? Reach out for pricing, availability, or to schedule a farm visit. We respond
              within 24 hours.
            </p>

            {[
              { ico: "📞", lab: "Phone / WhatsApp", val: "+92 324 0880157" },
              { ico: "📧", lab: "Email", val: "mahadrao3377@gmail.com" },
              ...
              <div
                ...
                <div
                  style={{
                    ...
                    fontSize: "16px",
                    flexShrink: 0,
                    boxShadow: `0 2px 14px rgba(212,175,55,0.38)`,
                  }}>
                  {row.ico}
                </div>
                <div>
                  ...
                  <div style={{ fontFamily: "'Montserrat',sans-serif", fontSize: "14px", color: t.text }}>
                    {row.val}
                  </div>
                </div>
              </div>
              ...
              <div
                ...
                {[
                  ...
                  <a
                    ...
                    onMouseEnter={(e) => {
                      e.currentTarget.style.transform = "scale(1.16) translateY(-3px)";
                      e.currentTarget.style.borderColor = t.goldB;
                      e.currentTarget.style.boxShadow = t.sGold;
                    }}
                    onMouseLeave={(e) => {

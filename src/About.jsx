...
export default function About({ t }) {
  ...
  return (
    <section id="about" ref={ref} style={{ padding:"120px 5%", background:t.bgAlt, position:"relative", overflow:"hidden" }}>
      {/* Faint pattern background */}
      <div style={{ position:"absolute", inset:0, pointerEvents:"none",
        backgroundImage:`repeating-linear-gradient(45deg,transparent,transparent 64px,rgba(212,175,55,0.028) 64px,rgba(212,175,55,0.028) 65px)` }} />
      ...
      <div style={{ maxWidth:"1200px", margin:"0 auto", position:"relative" }}>
        ...
        <SecTitle t={t} vis={vis}>About <GoldTx>RAO Farm</GoldTx></SecTitle>

        <div className="agrid" style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:"80px", alignItems:"center", marginTop:"64px" }}>
          ...
          <div style={{ opacity:vis?1:0, transform:vis?"translateX(0)":"translateX(60px)", transition:"all 0.9s cubic-bezier(0.16,1,0.3,1) 0.5s" }}>
            ...
            <div style={{ display:"grid", gridTemplateColumns:"repeat(3,1fr)", gap:"18px" }}>
              {[["500+","Cattle Raised"],["14","Years Exp."],["1000+","Happy Clients"]].map(([num,lab]) => (
